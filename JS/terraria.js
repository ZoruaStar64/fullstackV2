...
function showSpectreRecipe() {
    ...
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Spectre_Boots.png' alt='Spectre Boots'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p> " +
...
function showLightningRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Lightning_Boots.png' alt='Lightning Boots'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showFrostsparkRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Frostspark_Boots.png' alt='Frostspark Boots'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showObsidianskullRecipe1() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Obsidian_Skull.png' alt='Obsidian Skull'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showMoltencharmRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Molten_Charm.png' alt='Molten Charm'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showLavawadersRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Lava_Waders.png' alt='Lava Waders'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showplatWatchRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Platinum_Watch.png' alt='Platinum Watch'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br> " +
...
function showgoldWatchRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Gold_Watch.png' alt='Gold Watch'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br> " +
...
function showGPSRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/GPS.png' alt='GPS'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br> " +
...
function showREK3KRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/R.E.K._3000.png' alt='R.E.K 3000'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br> " +
...
function showGoblinRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Goblin_Tech.png' alt='Goblin Tech'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br> " +
...
function showFishRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Fish_Finder.png' alt='Fish Finder'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br> " +
...
function showPDARecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/PDA.png' alt='PDA'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br> " +
...
function showABRecipe() {
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Armor_Bracing.png' alt='Armor Bracing'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showMBRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Medicated_Bandage.png' alt='Medicated Bandage'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showCCMRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Countercurse_Mantra.png' alt='Countercurse Mantra'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showthePlanRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/The_Plan.png' alt='The Plan'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showOSRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Obsidian_Shield.png' alt='Obsidian Shield'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showBlindfold() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Blindfold.png' alt='Blindfold'><p style='float: right; margin: 10px 15% 0 0; font-size: 20px'>Obtained from</p><br><br><br>" +
...
function showACRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Ankh_Charm.png' alt='Ankh Charm'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showBoGRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(1.3)' src='../terrariaImg/Blade_of_Grass.png' alt='Blade of Grass'><p style='float: right; margin: 10px 15% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showMuramasaRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(1.3)' src='../terrariaImg/Muramasa.png' alt='Muramasa'><p style='float: right; margin: 10px 5% 0 0; font-size: 20px'>Obtained from</p><br><br>" +
...
function showFGSRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(1.3)' src='../terrariaImg/Fiery_Greatsword.png' alt='Fiery Greatsword'><p style='float: right; margin: 10px 5% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showLBRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(1.3)' src='../terrariaImg/Lights_Bane.png' alt='Lights Bane'><p style='float: right; margin: 10px 5% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showBBRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(1.3)' src='../terrariaImg/Blood_Butcherer.png' alt='Blood Butcherer'><p style='float: right; margin: 10px 5% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showNERecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(1.5)' src='../terrariaImg/Nights_Edge.png' alt='Nights Edge'><p style='float: right; margin: 10px 15% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showCBRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Chlorophyte_Bar.png' alt='Chlorophyte Bar'><p style='float: right; margin: 10px 15% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showExcaliburRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(1.3)' src='../terrariaImg/Excalibur.png' alt='Excalibur'><p style='float: right; margin: 10px 15% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showTExcaliburRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(1.5)' src='../terrariaImg/True_Excalibur.png' alt='True Excalibur'><p style='float: right; margin: 10px 15% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showTNERecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(1.5)' src='../terrariaImg/True_Nights_Edge.png' alt='True Nights Edge'><p style='float: right; margin: 10px 15% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showTerrabladeRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(1.5)' src='../terrariaImg/Terra_Blade.png' alt='Terra Blade'><p style='float: right; margin: 10px 15% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showCopperSSRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(1.5)' src='../terrariaImg/Copper_Shortsword.png' alt='Copper Shortsword'><p style='float: right; margin: 10px 15% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showStarfuryRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(1.5)' src='../terrariaImg/Starfury.png' alt='Starfury'><p style='float: right; margin: 10px 5% 0 0; font-size: 20px'>Obtained from</p><br><br>" +
...
function showESRecipe() {
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(1.5)' src='../terrariaImg/Enchanted_Sword.png' alt='Enchanted Sword'><p style='float: right; margin: 10px 5% 0 0; font-size: 20px'>Obtained from</p><br><br>" +
...
function showBKRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(1.5)' src='../terrariaImg/Bee_Keeper.png' alt='Bee Keeper'><p style='float: right; margin: 10px 5% 0 0; font-size: 20px'>Obtained from</p><br><br>" +
...
function showSeedlerRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(1.5)' src='../terrariaImg/Seedler.png' alt='Seedler'><p style='float: right; margin: 10px 5% 0 0; font-size: 20px'>Obtained from</p><br><br>" +
...
function showTHMBRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(1.5)' src='../terrariaImg/The_Horsemans_Blade.png' alt='The Horsemans Blade'><p style='float: right; margin: 10px 0 0 0; font-size: 20px'>Obtained from</p><br><br>" +
...
function showIWRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(1.5)' src='../terrariaImg/Influx_Waver.png' alt='Influx Waver'><p style='float: right; margin: 10px 5% 0 0; font-size: 20px'>Obtained from</p><br><br>" +
...
function showStarwrathRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(1.5)' src='../terrariaImg/Star_Wrath.png' alt='Star Wrath'><p style='float: right; margin: 10px 5% 0 0; font-size: 20px'>Obtained from</p><br><br>" +
...
function showMeowmereRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<div style='margin: 10px 0 0 10px'><img style='transform: scale(1.5)' src='../terrariaImg/Meowmere.png' alt='Meowmere'><p style='float: right; margin: 10px 5% 0 0; font-size: 20px'>Obtained from</p><br><br>" +
        "<img style='float: left' src='../terrariaImg/Moon_Lord.png' alt='Moon Lord'><p>11.11% chance</p></div>"
