...
function showSpectreRecipe() {
    ...
    craftGuide.innerHTML += "<p id='closeBox'>&times;</p><div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Spectre_Boots.png' alt='Spectre Boots'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p> " +
...
function showLightningRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<p id='closeBox'>&times;</p><div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Lightning_Boots.png' alt='Lightning Boots'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showFrostsparkRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<p id='closeBox'>&times;</p><div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Frostspark_Boots.png' alt='Frostspark Boots'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showMoltencharmRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<p id='closeBox'>&times;</p><div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Molten_Charm.png' alt='Molten Charm'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br>" +
...
function showLavawadersRecipe() {
    showCraftGuide();
    craftGuide.innerHTML = "";
    craftGuide.innerHTML += "<p id='closeBox'>&times;</p><div style='margin: 10px 0 0 10px'><img style='transform: scale(2)' src='../terrariaImg/Lava_Waders.png' alt='Lava Waders'><p style='float: right; margin: 10px 35% 0 0; font-size: 20px'>Made with</p><br><br>" +
